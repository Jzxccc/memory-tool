...
export const DESCRIPTION = 'Use to build project knowledge from source code analysis. Guide AI to read .analyze-dump.json, classify symbols, and generate structured .md files.';
