export const NAME = 'memory-write';
export const DESCRIPTION = 'Use when writing or updating knowledge entries. Guide AI to create correct frontmatter schema per node type. Supports depth-extracted methods, routes, and state machines.';
