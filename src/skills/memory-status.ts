export const NAME = 'memory-status';
export const DESCRIPTION = 'Use when checking knowledge base health, freshness, or completeness. Guide AI to run status and audit checks.';
